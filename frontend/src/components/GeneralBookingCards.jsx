...
//             <div className="mt-20 m-5 lg:ml-20 text-4xl font-bold tracking-tight text-white  dark:text-white">General Readings</div>
//             <div 
...
//                          key={index} className="rounded overflow-hidden shadow-lg bg-white flex flex-col">
