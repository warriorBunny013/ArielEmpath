...
function CareerBookingCards() {
    ...
    return (
        <div className="flex-wrap font-serif">
            <div className="mt-20 m-5 lg:ml-20 text-4xl font-bold tracking-tight text-black font-serif font-extralight flex justify-center underline decoration-wavy decoration-green-500 underline-offset-8 decoration-2 ">Services</div>
            <div
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                        ...
                        transition={{ duration: 1, ease: "easeInOut" }}
                         >
                            ...
                            <div className="px-6 py-4 mb-auto">
                                <div className="text-lg text-[1.3rem] font-bold text-gray-900 hover:text-indigo-600 cursor-pointer transition duration-500 ease-in-out inline-block mb-2">Career reading</div>
                        ...
                        transition={{ duration: 1, ease: "easeInOut" }}
                         >
                            ...
                            <div className="px-6 py-4 mb-auto">
                                <div className="text-lg text-[1.3rem] font-bold text-gray-900 hover:text-indigo-600 cursor-pointer transition duration-500 ease-in-out inline-block mb-2">Love reading</div>
                        ...
                        transition={{ duration: 1, ease: "easeInOut" }}
                         >
                            ...
                            <div className="px-6 py-4 mb-auto">
                                <div className="text-lg text-[1.3rem] font-bold text-gray-900 hover:text-indigo-600 cursor-pointer transition duration-500 ease-in-out inline-block mb-2">General Psychic Reading</div>
                                {/* <p className="text-gray-700 [word-spacing:2px] text-md">Descriptions</p> */}
                            </div>
                            <div className="px-6 py-3 flex flex-row items-center justify-between">
                                <button
                        ...
                        transition={{ duration: 1, ease: "easeInOut" }}
                         >
                            ...
                            <div className="px-6 py-4 mb-auto">
                                <div className="text-lg text-[1.3rem] font-bold text-gray-900 hover:text-indigo-600 cursor-pointer transition duration-500 ease-in-out inline-block mb-2">Tarot Phone Reading (One Hour Time Limit)</div>
                                {/* <p className="text-gray-700 [word-spacing:2px] text-md">Descriptions</p> */}
                            </div>
                            <div className="px-6 py-3 flex flex-row items-center justify-between">
                                <button
                        ...
                        transition={{ duration: 1, ease: "easeInOut" }}
                         >
                            ...
                            <div className="px-6 py-4 mb-auto">
                                <div className="text-lg text-[1.3rem] font-bold text-gray-900 hover:text-indigo-600 cursor-pointer transition duration-500 ease-in-out inline-block mb-2">What Are Their Intentions? (1 Person)</div>
                                {/* <p className="text-gray-700 [word-spacing:2px] text-md">Descriptions</p> */}
                            </div>
                            <div className="px-6 py-3 flex flex-row items-center justify-between">
                                <button
                        ...
                        transition={{ duration: 1, ease: "easeInOut" }}
                         >
                            ...
                            <div className="px-6 py-4 mb-auto">
                                <div className="text-lg text-[1.3rem] font-bold text-gray-900 hover:text-indigo-600 cursor-pointer transition duration-500 ease-in-out inline-block mb-2">What Are Their Intentions? (2 Person)</div>
                                {/* <p className="text-gray-700 [word-spacing:2px] text-md">Descriptions</p> */}
                            </div>
                            <div className="px-6 py-3 flex flex-row items-center justify-between">
                                <button
